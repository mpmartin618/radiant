...
async def mech_help(ctx):
    ...
    embed.add_field(name="Disclaimers:", value="Radiant font created by Nick Castillo (@AmazngNickanger on Twitter). \n\rAll rights, properties, and ownership of intellectual property are owned by Image comics, Kyle Higgins, and all parties associated with the Radiant Black universe.\n\rThis is an unoffical fan created font. This font is not meant to be used for comercial use, profit, or redistribution for personal financial gain. Please out of respect for it's creator and the community of Radiant Black, use this font respecfully.")
